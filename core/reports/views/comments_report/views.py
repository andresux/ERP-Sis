...
from core.college.models import Comments
from core.reports.forms import ReportForm
from core.security.mixins import AccessModuleMixin


class CommentsReportView(AccessModuleMixin, View):
    ...
    def get(self, request, *args, **kwargs):
        ...
        context['title'] = 'Informe de Quejas'
        return render(request, 'comments_report/report.html', context)
    ...
    def search_report(self):
        ...
        try:
            ...
            search = Comments.objects.filter()
            if filter == '1':
