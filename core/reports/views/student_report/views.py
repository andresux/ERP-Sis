...
class StudentReportView(AccessModuleMixin, View):
    ...
    def get(self, request, *args, **kwargs):
        ...
        context['title'] = 'Informe de Estudiantes'
        return render(request, 'student_report/report.html', context)
    ...
    def search_report(self):
        ...
        try:
            ...
            search = Person.objects.filter(type='estudiante')
            if filter == '1':
