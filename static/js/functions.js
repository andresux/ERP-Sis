...
function submit_to_ajax(url, parameters, callback) {
    $.ajax({
        url: url,
        data: parameters,
        method: 'POST',
...
function submit_formdata_ajax(fv) {
    var form = fv.form;
...
function dialog_submit_to_ajax(title, content, url, parameters, callback) {
    $.confirm({
        type: 'blue',
        theme: 'material',
        title: title,
...
function dialog_action(title, content, callback) {
    $.confirm({
        type: 'blue',
        theme: 'material',
        title: title,
...
function dialog_delete_to_ajax(title, content, url, parameters, callback) {
    $.confirm({
        type: 'blue',
        theme: 'material',
        title: title,
