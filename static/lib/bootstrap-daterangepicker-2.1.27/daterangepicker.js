...
(function (root, factory) {
    ...
    var DateRangePicker = function(element, options, cb) {
        ...
        this.cancelClass = 'btn-danger btn-flat';

        this.locale = {
            direction: 'ltr',
            format: moment.localeData().longDateFormat('L'),
            separator: ' - ',
            cancelLabel: '<i class="fa fa-times" aria-hidden="true"></i> Cancelar',
            applyLabel: '<i class="fa fa-search" aria-hidden="true"></i> Buscar',
            weekLabel: 'W',
